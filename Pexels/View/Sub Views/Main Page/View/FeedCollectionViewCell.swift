...
class FeedCollectionViewCell: UICollectionViewCell {
    ...
    @objc func bookmarkTapped() {
        ...
        if bookmarkButton.isSelected {
            NotificationCenter.default.post(name: .deleted, object: nil, userInfo: ["id" : photo.id])
            bookmarkButton.isSelected = false
        } else {
            NotificationCenter.default.post(name: .added, object: nil, userInfo: ["id" : photo.id])
